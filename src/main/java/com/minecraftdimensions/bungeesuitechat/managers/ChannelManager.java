...
public class ChannelManager {
	public static boolean recievedChannels = false;	
	...
	public static boolean playerHasPermissionToTalk(BSPlayer p) {
		...
		if(c.isDefault){
			...
			}else if(ChannelManager.isAdmin(c)){
				return p.getPlayer().hasPermission("bungeesuite.chat.channel.admin");
			}else{
				return false;
			}
		}else if(p.getPlayer().hasPermission("bungeesuite.chat.channel.custom")){
			return true;
		}else{
			return false;
		}
